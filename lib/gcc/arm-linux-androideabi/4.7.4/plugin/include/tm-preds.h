/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/jenkins/workspace/linaro-android_toolchain-4.7-2013.08/build/objdir/../build/../gcc/gcc-linaro-4.7-2013.08/gcc/config/arm/arm.md'.  */
